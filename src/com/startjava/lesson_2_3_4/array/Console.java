...
public class Console {
    ...
    public static void displayArrayByLines(int[] array, int rowLen) {
    ...
    public static void displayArrayBySevenNums(String msg, float[] array) {
        displayMsg(msg);
        for (int i = 0; i < array.length; i++) {
    ...
    public static void displayFactorialsExpr(long[] factorials, int... nums) {
        if (nums == null || nums.length == 0) {
            displayMsg(nums == null ? "Массив не существует.\n\n" : "Массив пуст.\n\n");
            return;
        }
        int len = nums.length;
        for (int i = 0; i < len; i++) {
            ...
            System.out.print(factorialExpr);
        }
    }
